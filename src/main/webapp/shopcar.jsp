    ...
    <tr valign="top" >
        <td>
            <table width="60%" border="0" cellspacing="1" cellpadding="2"
                ...
                <tr valign="bottom">
                    <td height="30"><img
                            src="https://image.freepik.com/free-icon/grocery-push-cart_318-40336.jpg" width="30" height="30">
                        <font
                    ...
                    <td>
                        ...
                        <table width="300" border="0" cellspacing="1" cellpadding="4"
                            ...
                            <tr bgcolor="#dadada">
                                ...
                                <td height="10" align="center" style="cursor:hand" onClick="javascript:history.go(-1)"><font
